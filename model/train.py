...
#             'MPV', 'Luxury'
#         ], 1000),
#         'price': np.random.randint(300000, 5000000, 1000)  # Prices in INR
#     })
...
def load_and_preprocess_data():
    # Sample Indian car data (improved with realistic patterns)
    np.random.seed(42)
    ...
    # Add price_per_year and mileage_per_year
...
if __name__ == "__main__":
    os.makedirs('model', exist_ok=True)
    os.makedirs('data', exist_ok=True)
    train_score, test_score, train_mae, test_mae = train_model()
